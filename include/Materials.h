...
constexpr std::array<MaterialProperties, static_cast<std::size_t>(MaterialType::COUNT)> MATERIAL_PROPERTIES = {{
    ...
    /* Water */               {false, true,  false, false, false, false, false,  100,     0,     false, true,  true,   false,  180,    0,     false,  false,  false,  false,     0,     0,     0,    90,    32, 128, 235,  45, 140, 245},
    ...
    /* Oil */                 {false, true,  false, false, true,  false, false,   90,     0,     false, true,  true,   false,  200,    0,     false,  false,  false,  false,     0,     0,     0,    50,   140, 120,  60, 100,  90,  40},
    ...
    /* Lava */                {false, true,  false, false, false, false, false,  230,    50,     true,  true,  false,  false,  255,  180,     false,  true,   true,   false,     0,     0,    90,    30,   255,  80,   0, 255, 150,  20},
    ...
    /* ToxicSludge */         {false, true,  false, false, false, false, false,  150,     0,     true,  false, true,   false,  220,   40,     false,  true,   false,  false,     0,     0,    60,    20,    80, 220,  60, 100, 255,  80},
    /* Acid */                {false, true,  false, false, false, false, false,  130,     0,     true,  true,  true,   false,  200,   50,     false,  true,   true,   false,     0,     0,    70,    40,    60, 230,  30,  90, 255,  50},
    /* Blood */               {false, true,  false, false, false, false, false,  140,     0,     false, false, false,  false,  225,    0,     false,  false,  false,  false,     0,     0,     0,    20,   200,  20,  20, 160,  10,  10},
    /* Slime */               {false, true,  false, false, false, false, false,  180,     5,     false, true,  true,   false,  200,    0,     false,  false,  false,  false,     0,     0,     0,    60,   180, 100, 220, 200, 130, 240},
    ...
    /* Poison */              {false, true,  false, false, false, false, false,  120,     0,     true,  false, true,   false,  210,   30,     false,  true,   false,  false,     0,     0,    50,    30,   180,  60, 220, 200,  80, 240},
    ...
    /* FreezingLiquid */      {false, true,  false, false, false, false, false,  110,     0,     true,  true,  true,   false,  190,   60,     false,  true,   true,   false,     0,     0,    80,    70,    70, 200, 255,  90, 220, 255},
    /* Honey */               {false, true,  false, false, true,  false, false,  175,    10,     false, true,  true,   false,  240,    0,     false,  false,  false,  false,     0,     0,     0,    50,   240, 200,  30, 255, 220,  40},
    /* VoidLiquid */          {false, true,  false, false, false, false, false,  255,   150,     true,  false, false,  true,   255,  100,     false,  true,   true,   false,     0,     0,   120,    10,    10,  10,  20,  40,  20,  60}
}};
